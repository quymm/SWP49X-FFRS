...
public class GPSLocationListener implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        Intent intent = new Intent("location-message");
