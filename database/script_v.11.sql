...
CREATE TABLE IF NOT EXISTS `capstone_project`.`profile` (
  ...
  `account_payable` FLOAT NULL DEFAULT 0,
  `avatar_url` VARCHAR(500) NULL,
  `rating_score` INT NULL,
  `bonus_point` INT NULL,
  `percent_profit` FLOAT NULL,
  `status` TINYINT(1) NOT NULL DEFAULT 1,
  `creation_date` DATETIME NOT NULL DEFAULT NOW(),
  `modification_date` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  PRIMARY KEY (`id`))
...
CREATE TABLE IF NOT EXISTS `capstone_project`.`account` (
  ...
  `num_of_report` INT NULL DEFAULT 0,
  `lock_status` TINYINT(1) NOT NULL DEFAULT 0,
  `staff_request_id` INT NULL,
  `request_lock` TINYINT(1) NOT NULL DEFAULT 0,
  `status` TINYINT(1) NOT NULL DEFAULT 1,
  `creation_date` DATETIME NOT NULL DEFAULT NOW(),
  `modification_date` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  ...
  INDEX `staff_request_ref_account_idx` (`staff_request_id` ASC),
  ...
  CONSTRAINT `account_ref_role`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `staff_request_ref_account`
...
CREATE TABLE IF NOT EXISTS `capstone_project`.`bill` (
  ...
  INDEX `bill_ref_field_owner_idx` (`field_owner_id` ASC),
  ...
  CONSTRAINT `bill_ref_user`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `bill_ref_field_owner`
    FOREIGN KEY (`field_owner_id`)
    REFERENCES `capstone_project`.`account` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `capstone_project`.`blacklist_opponent`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `capstone_project`.`blacklist_opponent` ;

CREATE TABLE IF NOT EXISTS `capstone_project`.`blacklist_opponent` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `opponent_id` INT NOT NULL,
  `status` TINYINT(1) NOT NULL,
  ...
  `modification_date` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  PRIMARY KEY (`id`),
  INDEX `blacklist_ref_account_idx` (`user_id` ASC),
  INDEX `blacklist_ref_opponent_idx` (`opponent_id` ASC),
  CONSTRAINT `blacklist_ref_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `capstone_project`.`account` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `blacklist_ref_opponent`
    FOREIGN KEY (`opponent_id`)
    REFERENCES `capstone_project`.`account` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `capstone_project`.`report`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `capstone_project`.`report` ;

CREATE TABLE IF NOT EXISTS `capstone_project`.`report` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `modification_date` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  PRIMARY KEY (`id`),
  INDEX `report_field_ref_user_idx` (`accuser_id` ASC),
  INDEX `report_field_ref_field_owner_idx` (`accused_id` ASC),
  ...
  CONSTRAINT `report_ref_user`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `report_ref_field_owner`
...
-- -----------------------------------------------------
-- Table `capstone_project`.`deposit_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `capstone_project`.`deposit_history` ;

CREATE TABLE IF NOT EXISTS `capstone_project`.`deposit_history` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  ...
  `modification_date` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  PRIMARY KEY (`id`),
  INDEX `deposit_history_ref_user_idx` (`user_id` ASC),
  CONSTRAINT `deposit_history_ref_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `capstone_project`.`account` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `capstone_project`.`standard_price`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `capstone_project`.`standard_price` ;
...
-- -----------------------------------------------------
-- Table `capstone_project`.`normal_match`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `capstone_project`.`normal_match` ;

CREATE TABLE IF NOT EXISTS `capstone_project`.`normal_match` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `time_slot_id` INT NOT NULL,
  `field_owner_id` INT NOT NULL,
  ...
  `modification_date` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  PRIMARY KEY (`id`),
  INDEX `normal_match_ref_time_slot_idx` (`time_slot_id` ASC),
  INDEX `normal_match_ref_field_owner_idx` (`field_owner_id` ASC),
  CONSTRAINT `normal_match_ref_time_slot`
    FOREIGN KEY (`time_slot_id`)
    REFERENCES `capstone_project`.`time_slot` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `normal_match_ref_field_owner`
    FOREIGN KEY (`field_owner_id`)
    REFERENCES `capstone_project`.`account` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `capstone_project`.`team_member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `capstone_project`.`team_member` ;

CREATE TABLE IF NOT EXISTS `capstone_project`.`team_member` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `player_name` VARCHAR(100) NOT NULL,
  ...
  `modification_date` DATETIME NOT NULL DEFAULT NOW() ON UPDATE NOW(),
  PRIMARY KEY (`id`),
  INDEX `team_member_ref_account_idx` (`captain_id` ASC),
  UNIQUE INDEX `player_name_UNIQUE` (`player_name` ASC),
  CONSTRAINT `team_member_ref_account`
